...
folder_path = 'cropped_data/ssp585/tiff'
...
# 调用函数处理不同变量
process_tif_files('cropped_data/ssp585/tiff', 'plus/585/MAP.tif', 'prec', operation="sum")
process_tif_files('cropped_data/ssp585/tiff', 'plus/585/TMAX.tif', 'tmax', operation="mean")
process_tif_files('cropped_data/ssp585/tiff', 'plus/585/TMIN.tif', 'tmin', operation="mean")
process_tif_files('cropped_data/ssp585/tiff', 'plus/585/TAVG.tif', 'tavg', operation="mean")
process_tif_files('cropped_data/ssp585/tiff', 'plus/585/SRAD.tif', 'srad', operation="mean")
process_tif_files('cropped_data/ssp585/tiff', 'plus/585/WIND.tif', 'wind', operation="mean")
process_tif_files('cropped_data/ssp585/tiff', 'plus/585/VAPR.tif', 'vapr', operation="mean")
