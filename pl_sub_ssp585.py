...
# 读取并绘制 TIFF 数据
# tif_file = f'result/ssp585/sub_585_rf.tif'
tif_file = f'cropped_result/tiff/sub_{ssp_scenario}_rf.tif'
...
# 保存图形到文件
output_dir = 'pic'
output_file_path = f'{output_dir}/sub_{ssp_scenario}_rf.png'
