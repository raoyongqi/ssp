...
folder_path = 'cropped_data/ssp370/tiff'
...
# 调用函数处理不同变量
process_tif_files('cropped_data/ssp370/tiff', 'plus/370/MAP.tif', 'prec', operation="sum")
process_tif_files('cropped_data/ssp370/tiff', 'plus/370/TMAX.tif', 'tmax', operation="mean")
process_tif_files('cropped_data/ssp370/tiff', 'plus/370/TMIN.tif', 'tmin', operation="mean")
process_tif_files('cropped_data/ssp370/tiff', 'plus/370/TAVG.tif', 'tavg', operation="mean")
process_tif_files('cropped_data/ssp370/tiff', 'plus/370/SRAD.tif', 'srad', operation="mean")
process_tif_files('cropped_data/ssp370/tiff', 'plus/370/WIND.tif', 'wind', operation="mean")
process_tif_files('cropped_data/ssp370/tiff', 'plus/370/VAPR.tif', 'vapr', operation="mean")
